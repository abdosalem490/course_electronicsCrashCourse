...
and Programming - TricksI\ directory.
...
This directory contains a complete copy of "Tricks of the Windows Game
Programming Gurus, 1st Edition" along with the source code. The files are
contained in:
