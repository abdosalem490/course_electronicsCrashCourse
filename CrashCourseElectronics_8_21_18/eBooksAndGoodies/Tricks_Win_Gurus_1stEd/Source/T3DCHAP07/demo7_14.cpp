...
int DDraw_Draw_Surface_Scaled(LPDIRECTDRAWSURFACE4 source, int x, int y, 
                      int width_src, int height_src, int width_dest, int height_dest, 
                      LPDIRECTDRAWSURFACE4 dest,  int transparent);   
...
int DDraw_Draw_Surface_Scaled(LPDIRECTDRAWSURFACE4 source, // source surface to draw
                      int x, int y,                 // position to draw at
