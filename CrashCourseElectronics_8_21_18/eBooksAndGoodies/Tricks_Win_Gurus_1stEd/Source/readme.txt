...
Microsoft VC++ 5.0, 6.0 along with DirectX 6.0+. Some basic things to
...
III. BONUS CHAPTER 15

Make sure to check out Bonus Chapter 15 (which is only on the CD). There is both a 
MS Word version of the chapter and an Adobe Acrobat version of the text.
