...
lpdijoy2->SetProperty(DIPROP_DEADZONE,&dead_band.diph);
...
// get joystick data
lpdijoy2->Poll(); // this is needed for joysticks only
lpdijoy2->GetDeviceState(sizeof(DIJOYSTATE2), (LPVOID)&joy_state);
...
// draw some text
Draw_Text_GDI("Let's Rock!!!",0,0,RGB(255,255,255),lpddsback);
