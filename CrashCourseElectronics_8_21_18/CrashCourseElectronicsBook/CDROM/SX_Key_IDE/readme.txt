...
and Programming - SX_Key_IDE\ directory.
...
This directory contains the Parallax SX-KEY IDE installer as well as 
SX-Sim, a Simulator for the SX Chip. The documentation for these 
programs can be found in the SX_Docs_Books\ directory.
