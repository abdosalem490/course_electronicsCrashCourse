...
and Programming - Datasheets\ directory.
...
This directory contains various datasheets from chip manufactures for
chips and components either used by the XGS ME and or discussed in the
text.