...
and Programming - XGSME_Studio\ directory.
...
This directory contains a copy of the XGS Micro Edition Studio in .ZIP
form, filename:

XGS_Micro_Studio.Zip

Simple decompress to a location on your harddrive.
