...
and Programming - Tools\ directory.
...
This directory contains a number of tools and applications that you 
might find useful, most are demos only, but at least save you the
time downloading.